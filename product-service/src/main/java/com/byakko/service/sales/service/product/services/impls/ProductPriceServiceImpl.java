...
import com.byakko.service.sales.service.product.mappers.ProductPriceMapper;
import com.byakko.service.sales.service.product.models.Employee;
...
import com.byakko.service.sales.service.product.repositories.ProductPriceRepository;
...
public class ProductPriceServiceImpl implements ProductPriceService {
    ...
    public ProductPriceResponse createProductPrice(CreateProductPriceCommand command) {
        ...
        productPrice.setEndDate(command.getEndDate() != null ? Instant.ofEpochSecond(command.getEndDate()).atZone(ZoneId.of(DomainConstants.ZONE_ID)).toLocalDate() : null);
