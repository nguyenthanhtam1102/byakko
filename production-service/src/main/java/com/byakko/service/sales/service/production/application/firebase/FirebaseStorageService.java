package com.byakko.service.sales.service.production.application.firebase;
...
public class FirebaseStorageService {
    ...
    public String uploadFile(MultipartFile multipartFile) {
        try {
            ...
            Blob blob = bucket.create(multipartFile.getOriginalFilename(), multipartFile.getInputStream(), "media", Bucket.BlobWriteOption.predefinedAcl(Storage.PredefinedAcl.PUBLIC_READ));
